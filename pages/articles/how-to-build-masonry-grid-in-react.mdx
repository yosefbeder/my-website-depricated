...
export const metaData = {
  ...
  imgSrc: 'https://i.postimg.cc/sygqTxtj/2021-09-13-09-32-12.png',
  description:
...
<iframe
  ...
  src="https://codepen.io/yosef_/embed/QWgpjpw?default-tab=html%2Cresult&theme-id=dark"
  frameborder="no"
  loading="lazy"
...
>
  See the Pen{' '}
  <a href="https://codepen.io/yosef_/pen/QWgpjpw">Masonry grid in React</a> by
  yosef (<a href="https://codepen.io/yosef_">@yosef_</a>) on{' '}
